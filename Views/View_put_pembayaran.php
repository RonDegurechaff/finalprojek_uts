        ...
        <div class="card-body text-dark">
            ...
            <form action="../Config/Routes.php?function=put_pembayaran" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select name="id_petugas" required class="form-select form-control">
                            <?php
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select name="id_spp" required class="form-select form-control">
                ...
                <input style="margin-left: 92%;" class="btn btn-warning text-white" type="submit" name="proses" value="Tambah">
            </form>
            </p>
        </div>
    </div>
