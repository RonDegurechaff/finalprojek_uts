...
class Model_siswa{
  ...
  function GETKelas(){
    ...
    function getData()
    {
        $this->query=mysqli_query($this->con, "select siswa.*, kelas.nama_kelas, spp.nominal from siswa join kelas on siswa.id_kelas = kelas.id_kelas join spp on siswa.id_spp = spp.id_spp")or die(mysqli_error()); 
